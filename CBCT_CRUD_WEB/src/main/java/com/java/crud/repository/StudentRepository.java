...
public class StudentRepository {
	...
	public List<Student> getStudent(){
        return  jdbcTemplate.query("select studentid,studentname,password,academic_year,emailid,school,branch,department from student",new StudentRowMapper());
    }
    ...
    public Integer updateStudent(Student student){
        String query="update student set studentname = ? , password = ? , academic_year = ? , emailid = ? , school = ? , branch = ? , department = ? where studentid = ?";
        Object[] params = {student.getStudentname() ,student.getPassword(),student.getAcademic_year(),student.getEmailid(),student.getSchool(),student.getBranch(), student.getDepartment(),student.getStudentid()};
